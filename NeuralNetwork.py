...
class Neural_Network:
    ...
    def __init__(self, num_inputs, num_hidden, num_outputs, hidden_layer_weights, output_layer_weights, learning_rate, hidden_bias=[0,0], output_bias=[0,0,0]):
    ...
    def forward_pass(self, inputs):
        ...
        return hidden_layer_outputs, output_layer_outputs[0]
    ...
    def backward_propagate_error(self, inputs, hidden_layer_outputs, output_layer_outputs, desired_outputs):
        ...
        #output_Error_ = self.cross_entropy(desired_outputs, output_layer_outputs)
        ...
        delta_output_bias_weights = output_delta
        delta_hidden_bias_weights = hidden_delta
    ...
    def train(self, instances, desired_outputs, epochs):
        ...
        for epoch in range(epochs):
            ...
            for idx in range(len(instances)):
                ...
                desired_out = [desired_outputs if len(desired_outputs.shape) == 1 else desired_outputs[idx]]
                ...
                delta_output_layer_weights, delta_hidden_layer_weights, delta_output_bias, delta_hidden_bias = self.backward_propagate_error(
                    instance, hidden_layer_outputs, output_layer_outputs, desired_out[0])
                predicted_class = np.argmax(output_layer_outputs)  # TODO!
                predictions.append(predicted_class)

                # Compare prediction with actual 
                if predicted_class == np.argmax(desired_out[0]):
